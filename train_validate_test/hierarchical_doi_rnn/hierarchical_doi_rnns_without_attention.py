...
def build_model(memory_rnn_cell, cpu_rnn_cell, system_call_rnn_cell, network_traffic_rnn_cell):
    ...
    memory_rnn_layer = RNN(cell=memory_rnn_cell)(memory_input_layer)
    memory_fully_connected_layer = Dense(units=fully_connected_layer_units, activation="relu")(memory_rnn_layer)

    cpu_input_layer = Input(shape=(n_step, cpu_n_input))
    cpu_rnn_layer = RNN(cell=cpu_rnn_cell)(cpu_input_layer)
    cpu_fully_connected_layer = Dense(units=fully_connected_layer_units, activation="relu")(cpu_rnn_layer)
    ...
    system_call_fully_connected_layer = Dense(units=fully_connected_layer_units, activation="relu")(system_call_rnn_layer)
    ...
    network_traffic_fully_connected_layer = Dense(units=fully_connected_layer_units, activation="relu")(network_traffic_rnn_layer)

    concatenate_layer = Concatenate(axis=-1)([memory_fully_connected_layer, cpu_fully_connected_layer, system_call_fully_connected_layer, network_traffic_fully_connected_layer])
